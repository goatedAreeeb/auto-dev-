...
_STUB_MODULES = [
    ...
    "immutables",
    # mergekit — imported by trl.mergekit_utils which is imported by callbacks.py
    "mergekit",
    "mergekit.config",
    "mergekit.common",
    "mergekit.merge",
...
sys.modules["vllm.sampling_params"].GuidedDecodingParams = _Dummy()
...
# so we inject stubs for every dotted path TRL touches.
